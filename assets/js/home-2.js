...
theme.addEventListener("click",()=>{body.classList.toggle("dark");theme.textContent=body.classList.contains("dark")?"☀":"◐";localStorage.setItem("apex-home2-theme",body.classList.contains("dark")?"dark":"light")});
if(localStorage.getItem("apex-home2-theme")==="dark"){body.classList.add("dark");theme.textContent="☀"}
