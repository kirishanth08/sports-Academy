...
theme.addEventListener("click",()=>{body.classList.toggle("dark");theme.textContent=body.classList.contains("dark")?"☀":"◐";localStorage.setItem("apex-about-theme",body.classList.contains("dark")?"dark":"light")});
if(localStorage.getItem("apex-about-theme")==="dark"){body.classList.add("dark");theme.textContent="☀"}
